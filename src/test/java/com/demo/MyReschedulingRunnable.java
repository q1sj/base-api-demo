 ...
 * @since 3.0
 */
public class MyReschedulingRunnable extends DelegatingErrorHandlingRunnable implements ScheduledFuture<Object> {

    private final TaskTest.AllowReFiresCronTrigger trigger;
    ...
    public MyReschedulingRunnable(
            Runnable delegate, TaskTest.AllowReFiresCronTrigger trigger, ScheduledExecutorService executor, ErrorHandler errorHandler) {
    ...
    public ScheduledFuture<?> schedule() {
        synchronized (this.triggerContextMonitor) {
            ...
            this.scheduledExecutionTime = this.trigger.nextExecutionTime(this.triggerContext, new Date(currentTimeMillis));
            if (this.scheduledExecutionTime == null) {
                return null;
            }
            long initialDelay = this.scheduledExecutionTime.getTime() - currentTimeMillis;
